...
GRANT SELECT, INSERT,         DELETE ON chars_alias              TO vndb_site;
GRANT SELECT, INSERT                 ON chars_alias_hist         TO vndb_site;
GRANT SELECT, INSERT,         DELETE ON chars_names              TO vndb_site;
GRANT SELECT, INSERT                 ON chars_names_hist         TO vndb_site;
...
GRANT SELECT, INSERT,         DELETE ON producers_extlinks       TO vndb_site;
GRANT SELECT, INSERT                 ON producers_extlinks_hist  TO vndb_site;
...
GRANT SELECT, INSERT,         DELETE ON releases_extlinks        TO vndb_site;
GRANT SELECT, INSERT                 ON releases_extlinks_hist   TO vndb_site;
...
GRANT SELECT, INSERT,         DELETE ON releases_supersedes      TO vndb_site;
GRANT SELECT, INSERT                 ON releases_supersedes_hist TO vndb_site;
...
GRANT SELECT, INSERT,         DELETE ON staff_extlinks           TO vndb_site;
GRANT SELECT, INSERT                 ON staff_extlinks_hist      TO vndb_site;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON tasks                    TO vndb_site;
...
GRANT SELECT, INSERT,         DELETE ON vn_extlinks              TO vndb_site;
GRANT SELECT, INSERT                 ON vn_extlinks_hist         TO vndb_site;
...
GRANT SELECT,         UPDATE         ON extlinks                 TO vndb_multi;
...
GRANT SELECT                         ON producers_extlinks       TO vndb_multi;
...
GRANT SELECT                         ON releases_extlinks        TO vndb_multi;
...
GRANT SELECT                         ON staff_extlinks           TO vndb_multi;
...
GRANT SELECT                         ON vn_extlinks              TO vndb_multi;
GRANT SELECT                         ON vn_hist                  TO vndb_multi;
GRANT SELECT,                 DELETE ON vn_length_votes          TO vndb_multi;
GRANT SELECT,                 DELETE ON vn_image_votes           TO vndb_multi;
