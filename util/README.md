...
`make gen/imgproc-custom` builds and links against a custom build of jpegli for
better JPEG compression. It also enables fairly restrictive seccomp rules for
secure sandboxing, to protect against potential vulnerabilities in the used
image codecs. This version likely only works on x86\_64 Linux with glibc. To
use this custom version, update `imgproc_path` in your conf.pl.
