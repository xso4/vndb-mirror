...
hash NTYPE =>
    announce  => { opt =>  0, mute => 1, txt => 'Site announcement',    desc => 'New thread on the "Announcements" forum, these are pretty rare' },
    ...
    subpost   => { opt => 10, mute => 0, txt => 'Forum post',           desc => 'New comment on a thread or review that you have subscribed to' },
